...
import style from "../styles/style"; // Ensure this is correctly used
...
const SignupPage = () => {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-bl from-green-500 to-blue-400 px-6 py-12 flex flex-col justify-center sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-3xl font-bold text-gray-950">
            Welcome..!! Register as a new user
          </h2>
